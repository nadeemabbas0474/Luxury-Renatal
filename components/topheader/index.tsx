...
export const TopHeader = () => {
  ...
  return (
    <>
      <div className="">
        <header className="fixed flex h-16 items-center bg-primaryMain rounded-3xl top-18 max-w-full right-5 left-28">
          {/* Logo area */}
          ...
          <div className="hidden md:flex md:min-w-0 md:flex-1 md:items-center md:justify-between">
            ...
            <div className="ml-10 flex flex-shrink-0 items-center space-x-10 pr-4">
              <nav aria-label="Global" className="flex space-x-10 text-white">
